...
__all__: List[str] = ["GRACENew"]


class GRACENew(torch.nn.Module):
    """
    ...
    * https://wandb.ai/sauravmaheshkar/GRACE/reports/Graph-Contrastive-Learning--Vmlldzo2MzYxODEy
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super(GRACENew, self).__init__(**kwargs)
    ...
    def train_step(
        ...
        # k = torch.tensor(int(z1.shape[0] * self.ratio))
        # p = (1/torch.sqrt(k))*torch.randn(k, z1.shape[0]).to(z1.device)
        # h1 = p @ z1
        # h2 = p @ z2 
        h1 = z1
        h2 = z2
